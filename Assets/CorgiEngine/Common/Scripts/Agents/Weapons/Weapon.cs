...
namespace MoreMountains.CorgiEngine
{
	...
	public class Weapon : MMMonoBehaviour
    {
        ...
        [FormerlySerializedAs("PreventAllMovementWhileInUse")] 
        [Tooltip("if this is true all movement will be prevented (even flip) while the weapon is active")]
        public bool PreventHorizontalMovementWhileInUse = false;
        ...
        public virtual void TurnWeaponOff()
        {
            ...
            if (PreventHorizontalMovementWhileInUse && (_characterHorizontalMovement != null))
            {
        ...
        protected virtual void ApplyRecoilInternal(WeaponRecoilProperties properties)
        {
            ...
            float force = _controller.State.IsGrounded ? RecoilOnUseProperties.RecoilForceGrounded : RecoilOnUseProperties.RecoilForceAirborne;
