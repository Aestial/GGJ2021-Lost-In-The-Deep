...
{	
	...
	{		
		...
		[Tooltip("the duration of dash (in seconds)")]
		...
		public override void ResetAbility()
		{
			...
			MMAnimatorExtensions.UpdateAnimatorBool(_animator, _dashingAnimationParameter, false, _character._animatorParameters);
		}
	}
}