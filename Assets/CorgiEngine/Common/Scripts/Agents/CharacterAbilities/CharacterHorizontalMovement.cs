...
{	
	...
	public class CharacterHorizontalMovement : CharacterAbility 
	{
		...
		{	
			...
			{
				groundAcceleration = _controller.Parameters.SpeedDecelerationInAir;
			}
			
			float movementFactor = _controller.State.IsGrounded ? groundAcceleration : airAcceleration;
			float movementSpeed = _normalizedHorizontalSpeed * MovementSpeed * _controller.Parameters.SpeedFactor * MovementSpeedMultiplier * StateSpeedMultiplier * PushSpeedMultiplier;
