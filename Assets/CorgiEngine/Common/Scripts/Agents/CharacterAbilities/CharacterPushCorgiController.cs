...
namespace MoreMountains.CorgiEngine
{
	...
	public class CharacterPushCorgiController : CharacterAbility
	{
        ...
        {
            base.ResetAbility();
            MMAnimatorExtensions.UpdateAnimatorBool(_animator, _pushingAnimationParameter, false, _character._animatorParameters);
            MMAnimatorExtensions.UpdateAnimatorBool(_animator, _pullingAnimationParameter, false, _character._animatorParameters);
        }
	}
}
