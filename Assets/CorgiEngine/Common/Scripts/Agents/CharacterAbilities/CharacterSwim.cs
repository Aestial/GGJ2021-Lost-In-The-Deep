...
namespace MoreMountains.CorgiEngine
{
    ...
    public class CharacterSwim : CharacterAbility
    {
        ...
        {
            base.ResetAbility();
            MMAnimatorExtensions.UpdateAnimatorBool(_animator, _swimmingAnimationParameter, false, _character._animatorParameters);
            MMAnimatorExtensions.UpdateAnimatorBool(_animator, _swimmingIdleAnimationParameter, false, _character._animatorParameters);
        }
    }
}
