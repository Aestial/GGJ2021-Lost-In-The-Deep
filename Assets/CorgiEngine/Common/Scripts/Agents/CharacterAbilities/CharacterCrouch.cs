...
{	
	...
	public class CharacterCrouch : CharacterAbility 
	{
		...
		public override void ResetAbility()
		{
			...
			MMAnimatorExtensions.UpdateAnimatorBool(_animator, _crouchingAnimationParameter, false, _character._animatorParameters);
			MMAnimatorExtensions.UpdateAnimatorBool(_animator, _crawlingAnimationParameter, false, _character._animatorParameters);
		}
	}
}